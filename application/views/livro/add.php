...
<?php echo form_open('livro/add', array("class" => "form-horizontal")); ?>
    ...
    <div class="col-md-8">
        <select name="personagem1" class="form-control">
            ...
            foreach ($all_pessoa as $pessoa) {
                $selected = ($pessoa['id'] == $this->input->post('personagem1')) ? ' selected="selected"' : "";
...
<div class="form-group">
    ...
    <div class="col-md-8">
        <select name="personagem2" class="form-control">
            ...
            <?php
            foreach ($all_pessoa as $pessoa) {
                $selected = ($pessoa['id'] == $this->input->post('personagem2')) ? ' selected="selected"' : "";
...
<?php
foreach ($all_pessoa as $pessoa) {
    $selected = ($pessoa['id'] == $this->input->post('personagem3')) ? ' selected="selected"' : "";
...
<?php
foreach ($all_pessoa as $pessoa) {
    $selected = ($pessoa['id'] == $this->input->post('personagem4')) ? ' selected="selected"' : "";
...
<?php
foreach ($all_pessoa as $pessoa) {
    $selected = ($pessoa['id'] == $this->input->post('autor')) ? ' selected="selected"' : "";
...
<div class="form-group">
    ...
    <div class="col-md-8">
        <input type="text" name="publicacao" value="<?php echo $this->input->post('publicacao'); ?>" class="form-control" id="publicacao" />
