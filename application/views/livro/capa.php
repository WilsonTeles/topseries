<?php echo form_open_multipart('livro/do_upload', array("class" => "form-horizontal")); ?>
...
<div class="form-group">
    <label for="capa" class="col-md-4 control-label"><span class="text-danger">*</span>Capa do Livro:</label>
    <div class="col-md-8">
