<?php echo form_open('serie/edit/' . $serie['id'], array("class" => "form-horizontal")); ?>
...
<div class="form-group">
    ...
    <div class="col-md-8">
        <select name="diretor" class="form-control">
            ...
            <?php
            foreach ($all_pessoa as $pessoa) {
                $selected = ($pessoa['id'] == $serie['diretor']) ? ' selected="selected"' : "";
...
<div class="form-group">
    <label for="id_genero" class="col-md-4 control-label"><span class="text-danger">*</span>Gênero</label>
    <div class="col-md-8">
        <select name="id_genero" class="form-control">
            <option value="">Selecionar Gênero</option>
            <?php
            foreach ($all_genero as $genero) {
                $selected = ($genero['id'] == $serie['id_genero']) ? ' selected="selected"' : "";
...
<div class="form-group">
    <label for="titulo" class="col-md-4 control-label"><span class="text-danger">*</span>Título</label>
    <div class="col-md-8">
        <input type="text" name="titulo" value="<?php echo ($this->input->post('titulo') ? $this->input->post('titulo') : $serie['titulo']); ?>" class="form-control" id="titulo" />
        <span class="text-danger"><?php echo form_error('titulo'); ?></span>
    </div>
</div>
<div class="form-group">
    <label for="episodios" class="col-md-4 control-label"><span class="text-danger">*</span>Episódios</label>
    <div class="col-md-8">
        <input type="text" name="episodios" value="<?php echo ($this->input->post('episodios') ? $this->input->post('episodios') : $serie['episodios']); ?>" class="form-control" id="episodios" />
...
<div class="form-group">
    ...
    <div class="col-md-8">
        <input type="text" name="temporadas" value="<?php echo ($this->input->post('temporadas') ? $this->input->post('temporadas') : $serie['temporadas']); ?>" class="form-control" id="temporadas" />
...
<div class="form-group">
    ...
    <div class="col-md-8">
        <input type="text" name="sinopse" value="<?php echo ($this->input->post('sinopse') ? $this->input->post('sinopse') : $serie['sinopse']); ?>" class="form-control" id="sinopse" />
